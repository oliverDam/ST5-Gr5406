...
Behandlingsforløbet for en patient med knæartrose består af flere behandlingsmetoder. Målet med behandling af knæartrose er smertelindring, mobilitetsforøgelse samt forebyggelse. Generelt kan metoderne inddeles i non-invasive og invasive, og behandlingsvalget afhænger af sygdommens omfang. \citep{Lind2016b} Et flowchart over behandlingsforløbet for en artrosepatient ses på \figref{fig:flow_behandlingsfaser}. 
...
Som det ses på \figref{fig:flow_behandlingsfaser} indebærer non-invasiv behandling livsstilsændringer, medicinsk behandling samt fysioterapi og den invasive behandling omhandler kirurgiske indgreb. Hvert område vil blive gennemgået nedenfor.  
